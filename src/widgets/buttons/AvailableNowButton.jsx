...
export default function AvailableNowButton({className}) {
  ...
  return (
      ...
      <span className='online-button__text online-button__text_1'>Available now</span>
      <span className='online-button__text online-button__text_2'>Available now</span>
      </Link>
  )
}
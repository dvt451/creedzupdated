...
export default function Links() {
  ...
  return (
   ...
   <Link onMouseEnter={()=>{_.setHoverAnyLink(true)}} onMouseLeave={()=>{_.setHoverAnyLink(false)}} onClick={()=>_.setHoverAnyLink(false)} className='usecase__link-project usecase__link-project_next' href={'/usecases/codelab'}>Next Project</Link>
</div>
  )
}

...
export default function Customcursor() {
   ...
   useEffect(() => {
      ...
      return (
         <div ref={cursorRef} className={`cursor${_.projectHover ? ' _active-project' : ''}${_.hoverAnyLink ? ' _active-link' : ''}`}>
      {location === '/portfolio' ? (<div className='cursor__portfolio'>{PortfolioMouseIcon}</div>) : (
